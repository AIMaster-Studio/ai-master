...
- 🐋 **浮动形象**：默认小鲸鱼，可拖拽，四边四分之一吸附，按压 Q 弹；带待机浮动动画，并会随机播放轻量日常动作（东张西望 / 漂浮踏步 / 摇扇纳凉等）
...
- 🎯 **随机提问**：点击鲸鱼弹出 AI 随机提问（判断对错 + 解析）；本地题库题目无需大模型即可判题，对/错自动播放回应动画
...
- ⚙️ **功能菜单**（右键鲸鱼打开）：形象切换、动画剧场、学习总结、问答、随机提问、背景美化、大小调节、音效开关与音量、气泡开关、休息提醒、智能睡眠、每日目标、今日数据、重置位置 / 清零统计
